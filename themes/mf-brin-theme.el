...
(deftheme mf-brin "mf version of brin theme.")

  (custom-theme-set-variables
    'mf-brin
    '(linum-format " %5i "))

  (let ((background "#1b1f25")
        (gutters    "#343d46")
        (gutter-fg  "#65737e")
...
`(org-block-begin-line
  ((t (:underline "#A7A6AA" :foreground ,text :background "#EAEAFF"))))
`(org-block-background
  ((t (:background "#2b303b"))))
`(org-block-end-line
  ((t (:overline "#A7A6AA" :foreground ,text :background ,background))))
